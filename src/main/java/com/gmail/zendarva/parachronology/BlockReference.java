...
public class BlockReference {
    ...
    public String toString() {
        return (Block.REGISTRY.getNameForObject(targBlock) + ":" + metadata);
    }
    ...
    public static BlockReference getReferenceFromBlock(Block block, int meta) {
        return BlockReference.readBlockFromString(Block.REGISTRY.getNameForObject(block) + ":" + meta);
    }
    ...
    private ItemStack getItemFromBlockStupidly(Block block) {
        ...
        return new ItemStack (Item.getByNameOrId(blockName),1,metadata);
    }
}
